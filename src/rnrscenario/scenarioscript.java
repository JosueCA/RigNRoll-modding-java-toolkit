...
implements ScenarioHost {
    ...
    void run_3_ceconds() {
        ...
        // Crash, this runs every 3 seconds !!!!
    ...
    void run_600_ceconds() {
    	RickRollLog.dumpStackTrace("scenarioscript run_600_seconds");
        if (!menues.cancreate_messagewindow()) {
            return;
        }
...
//        	PedestrianManager.getInstance().process();
        ...
        try {
            ...
            // eng.err(e.toString());
        	RickRollLog.dumpStackTrace("scenarioscript startQuickRace exception: " +e.getMessage());
        }
        MissionSystemInitializer.getMissionsManager().deinitialize();
        MenuResourcesManager.holdResources();
    }
