...
public class aiplayer implements IScriptRef {
  ...
  public String gPoolRefName() {
    return this.modelbasedmodel ? this.passport.modelName : (this.poolbasedmodel ? this.poolref_name : gNickName());
  }
  ...
  public IXMLSerializable getXmlSerializator() {
    return (IXMLSerializable)new AIPlayerSerializator(this);
  }
